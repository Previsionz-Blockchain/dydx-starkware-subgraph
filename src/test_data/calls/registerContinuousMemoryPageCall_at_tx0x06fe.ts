...
inputValues.push(
  new ethereum.EventParam(
    "values",
    ethereum.Value.fromUnsignedBigIntArray(batchOnChainData1)
  )
);
...
export let registerContinuousMemoryPageCall_at_tx0x06fe: RegisterContinuousMemoryPageCall = new RegisterContinuousMemoryPageCall(
